export const messages = {
  en: {
    ...
    nodeControls: 'Tab/n next  Shift-Tab/p prev', toggleControls: 'Space/Enter fold  d Details',
    compactHours: '{count}h', compactMinutes: '{count}m', compactSeconds: '{count}s',
    compactTurns: '{count} turns', compactTools: '{count} tools',
    details: 'Node details', activeRuns: 'Active runs: {count}', completedRuns: 'Completed runs ({count})', total: 'total', runningCount: '{count} running', waitingCount: '{count} waiting', selectedRun: 'Selected run: {name}', toggleCompleted: 'completed', noData: 'Unavailable', task: 'Task', description: 'Description',
    agent: 'Agent', model: 'Model', progress: 'Progress', turns: 'Turns', toolCalls: 'Tool calls',
    startedAt: 'Started', completedAt: 'Completed', taskStatus: 'Task status', elapsed: 'Elapsed',
    descendants: 'Subtasks (parent/child, not dependencies)', viewError: 'View preferences: {error}',
    ...
    pruneFailed: 'Could not prune expired snapshot: {error}',
  ...
  ko: {
    ...
    nodeControls: 'Tab/n 다음  Shift-Tab/p 이전', toggleControls: 'Space/Enter 접기  d 상세',
    compactHours: '{count}시간', compactMinutes: '{count}분', compactSeconds: '{count}초',
    compactTurns: '{count}턴', compactTools: '도구 {count}회',
    details: '노드 상세', activeRuns: '실행 중인 실행: {count}', completedRuns: '완료된 실행 ({count})', total: '전체', runningCount: '실행 중 {count}', waitingCount: '대기 {count}', selectedRun: '선택한 실행: {name}', toggleCompleted: '완료', noData: '정보 없음', task: '작업', description: '설명',
    agent: '에이전트', model: '모델', progress: '진행 상황', turns: '턴', toolCalls: '도구 호출',
    startedAt: '시작', completedAt: '완료', taskStatus: '작업 상태', elapsed: '경과',
    descendants: '하위 작업 (부모/자식, 의존 관계 아님)', viewError: '보기 설정: {error}',
    ...
    pruneFailed: '만료된 snapshot 정리 실패: {error}',
